...
advanced techniques
    ...
    \section{Load the dataset and describe
...
After removal of outliers 1455
    ...
    \subsubsection{Adjusting skewness}\label{adjusting-skewness}
...
\end{tcolorbox}
    ...
    \subsection{Training a Baseline model}\label{training-a-baseline-model}
